	    ...
	    for (k=0;k<N;k++)
       	{
	       	if (i==0)
	    	{
	    		if (j==0)
	    		{
	    			if (k==0)
	    			{
	    				sum = sumarround(a[0][0][1][0], a[0][1][0][0], a[0][1][1][0], a[1][0][0][0], a[1][1][0][0], a[1][0][1][0], a[1][1][1][0], a[0][0][N-1][0], a[0][1][N-1][0], a[1][0][N-1][0], a[1][1][N-1][0], a[0][N-1][0][0], a[1][N-1][0][0], a[0][N-1][1][0], a[1][N-1][1][0], a[N-1][0][0][0], a[N-1][1][0][0], a[N-1][0][1][0], a[N-1][1][1][0], a[0][N-1][N-1][0], a[1][N-1][N-1][0], a[N-1][N-1][0][0], a[N-1][N-1][1][0], a[N-1][0][N-1][0], a[N-1][0][N-1][0], a[N-1][N-1][N-1][0]);
	    				b[i][j][k][0]=status(sum,b[i][j][k][0]);

	    				b[i][j][k][0] = get_color(a[i][j][k][0], a[0][0][1][1], a[0][1][0][1], a[0][1][1][1], a[1][0][0][1], a[1][1][0][1], a[1][0][1][1], a[1][1][1][1], a[0][0][N-1][1], a[0][1][N-1][1], a[1][0][N-1][1], a[1][1][N-1][1], a[0][N-1][0][1], a[1][N-1][0][1], a[0][N-1][1][1], a[1][N-1][1][1], a[N-1][0][0][1], a[N-1][1][0][1], a[N-1][0][1][1], a[N-1][1][1][1], a[0][N-1][N-1][1], a[1][N-1][N-1][1], a[N-1][N-1][0][1], a[N-1][N-1][1][1], a[N-1][0][N-1][1], a[N-1][0][N-1][1], a[N-1][N-1][N-1][1]);
	    			}
	    			else if(k==N-1)
	    			{
	    				sum = sumarround(a[0][0][0][0], a[0][1][0][0], a[1][1][0][0], a[1][0][0][0], a[N-1][0][N-1][0], a[N-1][1][N-1][0], a[N-1][0][N-2][0], a[N-1][1][N-2][0], a[0][N-1][N-1][0], a[1][N-1][N-1][0], a[0][N-1][N-2][0], a[1][N-1][N-2][0], a[N-1][N-1][0], a[0][N-1][0][0], a[1][N-1][0][0], a[N-1][N-1][N-1][0], a[N-1][N-1][N-2][0], a[N-1][0][0][0], a[N-1][1][0][0], a[1][0][N-1][0], a[0][0][N-2][0], a[0][1][N-1][0], a[1][1][N-1][0], a[0][1][N-2][0], a[1][1][N-2][0], a[1][0][N-2][0]);
	    				b[i][j][k][0]=status(sum,b[i][j][k][0]);

	    				b[i][j][k][0] = get_color(a[0][0][0][0], a[0][1][0][0], a[1][1][0][0], a[1][0][0][0], a[N-1][0][N-1][0], a[N-1][1][N-1][0], a[N-1][0][N-2][0], a[N-1][1][N-2][0], a[0][N-1][N-1][0], a[1][N-1][N-1][0], a[0][N-1][N-2][0], a[1][N-1][N-2][0], a[N-1][N-1][0], a[0][N-1][0][0], a[1][N-1][0][0], a[N-1][N-1][N-1][0], a[N-1][N-1][N-2][0], a[N-1][0][0][0], a[N-1][1][0][0], a[1][0][N-1][0], a[0][0][N-2][0], a[0][1][N-1][0], a[1][1][N-1][0], a[0][1][N-2][0], a[1][1][N-2][0], a[1][0][N-2][0]);
	    			}
	    			else
	    			{
	    				sum = sumarround(a[0][0][k+1][0], a[i][j][k-1][0], a[i+1][j][k][0], a[i+1][j][k+1][0], a[i+1][j][k-1][0], a[i][j+1][k][0], a[i][j+1][k+1][0], a[i][j+1][k-1][0], a[i+1][j+1][k][0], a[i+1][j+1][k+1][0], a[i+1][j+1][k-1][0], a[N-1][0][k][0], a[N-1][0][k-1][0], a[N-1][0][k+1][0], a[N-1][1][k][0], a[N-1][1][k-1][0], a[N-1][1][k+1][0], a[0][N-1][k][0], a[0][N-1][k+1][0], a[0][N-1][k-1][0], a[1][N-1][k][0], a[1][N-1][k+1][0], a[1][N-1][k-1][0], a[N-1][N-1][k][0], a[N-1][N-1][k+1][0], a[N-1][N-1][k-1][0]);
	    				b[i][j][k][0] = status(sum, b[i][j][k][0])

	    				b[i][j][k][0] = get_color(a[0][0][k+1][0], a[i][j][k-1][0], a[i+1][j][k][0], a[i+1][j][k+1][0], a[i+1][j][k-1][0], a[i][j+1][k][0], a[i][j+1][k+1][0], a[i][j+1][k-1][0], a[i+1][j+1][k][0], a[i+1][j+1][k+1][0], a[i+1][j+1][k-1][0], a[N-1][0][k][0], a[N-1][0][k-1][0], a[N-1][0][k+1][0], a[N-1][1][k][0], a[N-1][1][k-1][0], a[N-1][1][k+1][0], a[0][N-1][k][0], a[0][N-1][k+1][0], a[0][N-1][k-1][0], a[1][N-1][k][0], a[1][N-1][k+1][0], a[1][N-1][k-1][0], a[N-1][N-1][k][0], a[N-1][N-1][k+1][0], a[N-1][N-1][k-1][0]);
	    			}
	    		}
        	}
        }
